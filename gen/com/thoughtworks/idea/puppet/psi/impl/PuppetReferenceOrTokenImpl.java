...
public class PuppetReferenceOrTokenImpl extends PuppetRefOrTokenImpl implements PuppetReferenceOrToken {

  public PuppetReferenceOrTokenImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getId() {
    return findNotNullChildByType(PP_ID);
  }
