...
public class PuppetExpressionImpl extends PuppetCompositeElementImpl implements PuppetExpression {

  public PuppetExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getChoice() {
    return findChildByType(PP_CHOICE);
  }
